class Item < JupiterCore::Doiable
  ...
  def self.from_draft(draft_item)
    ...
    if draft_item.visibility_as_uri == ControlledVocabulary.era.visibility.embargo
      ...
      item.add_to_embargo_history if item.visibility == ControlledVocabulary.era.visibility.embargo
