class AddIsEraPublishedColumn < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column :ar_collections, :is_published_in_era, :boolean, default: false, index: true
    add_column :ar_communities, :is_published_in_era, :boolean, default: false, index: true
  end
end
