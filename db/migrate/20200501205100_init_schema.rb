class InitSchema < ActiveRecord::Migration[6.0]
  def up
    ...
    create_table "communities", id: :uuid, default: -> { "uuid_generate_v4()" } do |t|
      t.string "visibility"
      t.bigint "owner_id", null: false
      t.datetime "record_created_at"
      t.string "hydra_noid"
    ...
    create_table "draft_items", id: :uuid, default: -> { "uuid_generate_v4()" } do |t|
      t.uuid "uuid"
    ...
    create_table "draft_theses", id: :uuid, default: -> { "uuid_generate_v4()" } do |t|
      t.string "uuid"
      t.integer "status", default: 0, null: false
      t.integer "wizard_step", default: 0, null: false
      t.bigint "user_id", null: false
    ...
    create_table "theses", id: :uuid, default: -> { "uuid_generate_v4()" } do |t|
      t.string "visibility"
      t.bigint "owner_id", null: false
      t.datetime "record_created_at"
      t.string "hydra_noid"
