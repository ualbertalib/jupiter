...
gem 'flipper', '~> 0.28.0' # Feature flags for Ruby
gem 'flipper-active_record', '~> 0.28.0' # Store feature flags in ActiveRecord
gem 'flipper-ui', '~> 0.28.0' # UI for feature flags
