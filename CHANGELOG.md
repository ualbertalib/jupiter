...
### Security
- bump omniauth from 1.9.0 to 1.9.1 [PR#1513](https://github.com/ualbertalib/jupiter/pull/1513)
- bump puma from 4.3.1 to 4.3.3 [CVE#2020-5247](https://github.com/rubysec/ruby-advisory-db/blob/master/gems/puma/CVE-2020-5247.yml)
