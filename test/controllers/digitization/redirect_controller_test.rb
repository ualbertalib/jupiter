...
class Digitization::RedirectControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should redirect Peel monograph' do
    ...
    assert_redirected_to book_url(digitization_books(:peel_monograph))
  end
  ...
  test 'should redirect Peel Henderson directory' do
    ...
    assert_response :moved_permanently
    assert_redirected_to book_url(digitization_books(:henderson))
  end
  ...
  test 'should redirect Peel Folk Fest pamphlet' do
    ...
    assert_response :moved_permanently
    assert_redirected_to book_url(digitization_books(:folk_fest))
  end
  ...
  test 'should redirect Peel newspaper' do
    ...
    assert_response :moved_permanently
    assert_redirected_to newspaper_url(digitization_newspapers(:la_survivance))
  end
  ...
  test 'should redirect Peel Magee photograph' do
    ...
    assert_response :moved_permanently
    assert_redirected_to image_url(digitization_images(:magee))
  end
  ...
  test 'should redirect Peel Prairie postcard' do
    ...
    assert_response :moved_permanently
    assert_redirected_to image_url(digitization_images(:postcard))
  end
  ...
  test 'should redirect Peel map' do
    ...
    assert_response :moved_permanently
    assert_redirected_to map_url(digitization_maps(:map))
  end
