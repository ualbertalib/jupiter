...
Rails.application.routes.default_url_options = { host: Rails.application.secrets.era_host, protocol: 'https' }
...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "jupiter_#{Rails.env}"
